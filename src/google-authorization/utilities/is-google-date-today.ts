/**
 * @description Checks if a given date string represents "today" in the user's local time zone.
 * Parses dateString for 2026-05-10T14:00:00-08:00 or 2026-05-10T22:00:00.000Z or 2026-05-10 formats, and compares to today's date.
 ...
 * @returns {boolean}
 */
export function isGoogleDateToday(dateString: string): boolean {
    ...
    if (match) {
        ...
        return parsedDate.getTime() === todayNormalized.getTime();
    }
