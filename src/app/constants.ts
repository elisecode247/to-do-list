...
export const API_URL = !isLocal ? "https://demo-server-production-9fc2.up.railway.app" : import.meta.env.VITE_API_URL;
...
export const API_CHORES_URL = !isLocal ? "https://demo-server-production-9fc2.up.railway.app/chores" : import.meta.env.VITE_API_CHORES_URL;
export const API_JOURNAL_URL = !isLocal ? "https://demo-server-production-9fc2.up.railway.app/journal" : import.meta.env.VITE_API_JOURNAL_URL;
